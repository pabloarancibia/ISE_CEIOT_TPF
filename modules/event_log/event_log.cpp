...
static char seconds_countdown = 0;
static bool countdownState = OFF;
...
void eventLogUpdate()
{
    ...
    // int countdown_currentState = countdownRead();
    // if (countdown_currentState > 0){
    //     currentState = ON;
    // }
    // eventLogElementStateUpdate( countdownState ,currentState, "COUNTDOWN" );
